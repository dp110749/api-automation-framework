...
Scenario Outline: To test the functionality of LE FTSP API when we pass the valid 
    ...
    Then I verify the response status code "<StatusCode>"
    And I try to validate the response time response type and response app id for LE FTSP
    And I try to validate response  message  discription "Incorrect LE Details Status:false" and correlation id "31873127329799381273192121"
    ...
    When I send the complete request body for "<RequestBody>"
    Then I verify the response status code "<StatusCode>"
 #   And I try to validate the generated premium is partA "80000" and premium partB "80000" and premium partC "80000"
    And I try to validate the response time response type and response app id for LE FTSP
    And I try to validate response  message  discription "Premium generated Successfully" and correlation id "31873127329799381273192121"
